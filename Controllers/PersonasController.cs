...
namespace ProyectoWeb.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Empresas = context.TbEmpresa.Select(s => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem { Text = s.Nombre, Value = s.Nombre });
            ViewBag.Tipo = context.CtClienteprovedor.Select(s => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem { Text = s.Descripcion, Value = s.IdClienteProvedor.ToString() });
            return View(list);
        }
